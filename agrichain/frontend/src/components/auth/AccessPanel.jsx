        ...
        <div className="stack-list top-gap">
          ...
          <div className="form-grid two-col-grid">
            <label className="field-stack" htmlFor="register-role">
              Role
              <select id="register-role" name="user_type" value={registerForm.user_type} onChange={(event) => onRegisterField("user_type", event.target.value)}>
                {ROLE_OPTIONS.map((option) => <option key={option.value} value={option.value}>{option.label}</option>)}
              </select>
            </label>
            <label className="field-stack" htmlFor="register-market">
              Market preference
              <select id="register-market" name="market_type" value={registerForm.market_type} onChange={(event) => onRegisterField("market_type", event.target.value)}>
          ...
          <label className="field-stack" htmlFor="register-language">
            Language
            <select id="register-language" name="language" value={registerForm.language} onChange={(event) => onRegisterField("language", event.target.value)}>
